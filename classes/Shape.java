...
public abstract class Shape implements Colorable {
	...
	//Superclass generally refers to the parent class of whatever node you are talking about
	//Rectangle, Circle => Shape
	
	//Shape - Datafields: color
	//Rectangle - Datafields: base, height, numberOfRectangles;  Circle - Datafields: radius

	//Data fields
	protected String color; //allows this.color in all private classes
	...
	/*
	@Override
	public String doesNotExistInSuperClass() {
		return "Hello";
	}
	*/
	
	/**
	 * The @Override tells Eclipse the method is being over-ridden - it doesn't change anything otherwise
	 */
	@Override
